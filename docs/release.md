...
The Public visibility migration was manually published and API authentication was
bootstrapped on 2026-07-24. The same tag workflow passes the verified extension ZIP to
